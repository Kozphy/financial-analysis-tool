...
- `financial/`: financial statement models, loading, metrics, reporting, and visualization
- `quant/`: price loading, Binance exchange ingestion, factor calculation, portfolio construction, and backtesting
