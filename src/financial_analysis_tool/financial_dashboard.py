"""Streamlit views and helpers for the financial analysis dashboard."""
...
def render_financial_dashboard(st, pd) -> None:
    """Render the financial analysis dashboard workflow."""
    with st.sidebar:
